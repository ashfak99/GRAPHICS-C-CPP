...
// Function to round up the interval for scaling
...
// Function to plot a graph using pointers to vectors for vx and vy
void GraphPlot(int n, int *vx, int *vy, char *sx, char *sy) {
    ...
    // Draw the graph line using vx and vy arrays
    for (int i = 0; i < n - 1; i++) {
